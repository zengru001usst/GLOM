...
flags.DEFINE_integer('batch_size', 800, 'Batch size.') #1024
...
flags.DEFINE_float('learning_rate', 0.012, 'Learning rate.')
...
flags.DEFINE_string('load_checkpoint_dir', 'epoch=199-step=10000.ckpt',
                    'Load previous existing checkpoint.')
flags.DEFINE_integer('seed', 42, 'Seed.')
flags.DEFINE_integer('max_epochs', 200, 'Number of training epochs.') # 10000
